...
},{}],"bookmarks-dates-dev.js":[function(require,module,exports) {
"use strict";
...
output.innerText = "Выберите файл"; // When a bookmark file is choosen, the function 'getFile' is started.

document.getElementById("input").onchange = getFile; // Function 'addDate' adds a div element with the date of bookmark creation after the inputElement.
// Attribute 'ADD_DATE' has a Unix timestamp in seconds.
// Tag "H3" has a title of folder.

function addDate(inputElement) {
  var element = inputElement;
  var attributeValue, div, date;
...
function convertUnixTime(date) {
  ...
  var calendarDate = dateInstance.toString().slice(0, 25);
  return calendarDate;
...
function getFile(e) {
  ...
  reader.onload = function (e) {
    ...
    var fileForSave = new File([outputFile], "bookmark-result.html", {
      type: "text/plain;charset=utf-8"
    });

    _fileSaver.default.saveAs(fileForSave);
  };

  reader.readAsText(inputFile);
}
},{"file-saver":"node_modules/file-saver/dist/FileSaver.min.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","bookmarks-dates-dev.js"], null)
//# sourceMappingURL=/bookmarks-dates-dev.b499aa74.js.map
